  ...
  public class StoreManager
  {
    ...
    public IEnumerable<Entitlement> GetEntitlements()
    {
      ...
      for (int index = 0; index < num; ++index)
        entitlementList.Add(this.GetEntitlementAt(index));
      return (IEnumerable<Entitlement>) entitlementList;
    }
    ...
    public IEnumerable<Sku> GetSkus()
    {
      ...
      for (int index = 0; index < num; ++index)
        skuList.Add(this.GetSkuAt(index));
      return (IEnumerable<Sku>) skuList;
    }
