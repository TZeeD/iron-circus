...
namespace Discord
{
  public class LobbyManager
  {
    ...
    {
      LobbyTransaction lobbyTransaction = new LobbyTransaction();
    ...
    public LobbyMemberTransaction GetMemberUpdateTransaction(
      ...
      long userId)
    {
      LobbyMemberTransaction memberTransaction = new LobbyMemberTransaction();
      Result result = this.Methods.GetMemberUpdateTransaction(this.MethodsPtr, lobbyId, userId, ref memberTransaction.MethodsPtr);
      if (result != Result.Ok)
        throw new ResultException(result);
    ...
    {
      LobbySearchQuery lobbySearchQuery = new LobbySearchQuery();
    ...
    public IEnumerable<User> GetMemberUsers(long lobbyID)
    {
      ...
      for (int index = 0; index < num; ++index)
        userList.Add(this.GetMemberUser(lobbyID, this.GetMemberUserId(lobbyID, index)));
      return (IEnumerable<User>) userList;
    }
