...
// Type: SteelCircus.FX.Skills.Floor.VirtualStrikeAoePreview
...
{
  public class VirtualStrikeAoePreview : CustomAoePreviewBase
  {
    ...
    public override void SetAoe(AreaOfEffect aoe)
    {
      ...
      this.SetPropertyIfExists(VirtualStrikeAoePreview._OutlineWidth, 0.07f / aoe.radius);
      this.buildupDuration = 0.1f;
    }
  }
}
