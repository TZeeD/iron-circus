...
// Type: SteelCircus.FX.Skills.Floor.CageAoePreview
...
{
  public class CageAoePreview : CustomAoePreviewBase
  {
    ...
    public override void SetAoe(AreaOfEffect aoe)
    {
      ...
      this.SetPropertyIfExists(CageAoePreview._OutlineWidth, 0.07f / aoe.radius);
