...
// Type: SteelCircus.FX.Skills.Floor.LightningStrikeTeleportAoePreview
...
{
  public class LightningStrikeTeleportAoePreview : CustomAoePreviewBase
  {
    ...
    public override void SetAoe(AreaOfEffect aoe)
    {
      ...
      this.SetPropertyIfExists(LightningStrikeTeleportAoePreview._OutlineWidth, 0.07f / aoe.radius);
