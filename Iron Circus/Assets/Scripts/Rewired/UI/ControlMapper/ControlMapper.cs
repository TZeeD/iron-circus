...
namespace Rewired.UI.ControlMapper
{
  ...
  public class ControlMapper : MonoBehaviour
  {
    ...
    private int inputGridWidth => this._actionLabelWidth + (this._showKeyboard ? this._keyboardColMaxWidth : 0) + (this._showMouse ? this._mouseColMaxWidth : 0) + (this._showControllers ? this._controllerColMaxWidth : 0) + (this.inputGridColumnCount - 1) * this._inputColumnSpacing;

    private Player currentPlayer => ReInput.players.GetPlayer(this.currentPlayerId);

    private InputCategory currentMapCategory => (InputCategory) ReInput.mapping.GetMapCategory(this.currentMapCategoryId);
    ...
    private GameObject currentUISelection => !((UnityEngine.Object) EventSystem.current != (UnityEngine.Object) null) ? (GameObject) null : EventSystem.current.currentSelectedGameObject;

    private bool showSettings => this._showInputBehaviorSettings && (uint) this._inputBehaviorSettings.Length > 0U;
    ...
    public void OnInputFieldActivated(InputFieldInfo fieldInfo)
    {
      ...
      if (controllerMap == null)
        return;
      ActionElementMap aem = fieldInfo.actionElementMapId >= 0 ? controllerMap.GetElementMap(fieldInfo.actionElementMapId) : (ActionElementMap) null;
      if (aem != null)
    ...
    private void ShowControllerAssignmentConflictWindow(int controllerId)
    {
      ...
      window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetControllerAssignmentConflictWindowMessage(joystick.name, otherPlayerName, this.currentPlayer.descriptiveName));
    ...
    private void ShowMouseAssignmentConflictWindow()
    {
      ...
      window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetMouseAssignmentConflictWindowMessage(otherPlayerName, this.currentPlayer.descriptiveName));
      UnityAction unityAction = (UnityAction) (() => this.OnWindowCancel(window.id));
      window.cancelCallback = unityAction;
    ...
    private void ShowCalibrateAxisStep1Window()
    {
      ...
      window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetCalibrateAxisStep1WindowMessage(joystick.AxisElementIdentifiers[axisIndex].name));
      if ((UnityEngine.Object) this.prefabs.centerStickGraphic != (UnityEngine.Object) null)
        window.AddContentImage(this.prefabs.centerStickGraphic, UIPivot.BottomCenter, UIAnchor.BottomCenter, new Vector2(0.0f, 40f));
      window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, UIAnchor.BottomHStretch, Vector2.zero, "");
    ...
    private void ShowCalibrateAxisStep2Window()
    {
      ...
      window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetCalibrateAxisStep2WindowMessage(joystick.AxisElementIdentifiers[axisIndex].name));
    ...
    private void CreateActionLabelColumn() => this.references.inputGridActionColumn = this.CreateNewColumnGroup("ActionLabelColumn", this.references.inputGridInnerGroup, this._actionLabelWidth).transform;
            ...
            for (int index2 = 0; index2 < actionCategoryIds.Count; ++index2)
            {
              ...
              if (actionCategory != null && actionCategory.userAssignable && this.CountIEnumerable<InputAction>(ReInput.mapping.UserAssignableActionsInCategory(actionCategory.id)) != 0)
              {
                if (this._showActionCategoryLabels)
                {
                  ...
                  Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(actionCategory.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) num1));
                ...
                foreach (InputAction inputAction in ReInput.mapping.UserAssignableActionsInCategory(actionCategory.id, true))
                {
                  if (inputAction.type == InputActionType.Axis)
                  {
                    if (this._showFullAxisInputFields)
                    {
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(inputAction.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) num1));
                      label.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, (float) this._inputRowHeight);
                    ...
                    if (this._showSplitAxisInputFields)
                    {
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label1 = this.CreateLabel(!string.IsNullOrEmpty(inputAction.positiveDescriptiveName) ? inputAction.positiveDescriptiveName : inputAction.descriptiveName + " +", gridActionColumn, new Vector2(0.0f, (float) num1));
                      ...
                      num1 -= this._inputRowHeight;
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label2 = this.CreateLabel(!string.IsNullOrEmpty(inputAction.negativeDescriptiveName) ? inputAction.negativeDescriptiveName : inputAction.descriptiveName + " -", gridActionColumn, new Vector2(0.0f, (float) num1));
              ...
              if (action != null && action.userAssignable)
              {
                ...
                if (actionCategory != null && actionCategory.userAssignable)
                {
                  if (action.type == InputActionType.Axis)
                  {
                    if (this._showFullAxisInputFields)
                    {
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(action.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) num1));
                      label.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, (float) this._inputRowHeight);
                    ...
                    if (this._showSplitAxisInputFields)
                    {
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label3 = this.CreateLabel(action.positiveDescriptiveName, gridActionColumn, new Vector2(0.0f, (float) num1));
                      ...
                      int num3 = num1 - this._inputRowHeight;
                      Rewired.UI.ControlMapper.ControlMapper.GUILabel label4 = this.CreateLabel(action.negativeDescriptiveName, gridActionColumn, new Vector2(0.0f, (float) num3));
                      ...
                      num1 = num3 - this._inputRowHeight;
                    }
                  }
                  else if (action.type == InputActionType.Button)
                  {
    ...
    private Window OpenWindow(GameObject windowPrefab, bool closeOthers) => this.OpenWindow(windowPrefab, string.Empty, closeOthers);
    ...
    private void OnUIElementSelected(GameObject selectedObject) => this.lastUISelection = selectedObject;
    ...
    private int GetMaxControllersPerPlayer() => this._rewiredInputManager.userData.ConfigVars.autoAssignJoysticks ? this._rewiredInputManager.userData.ConfigVars.maxJoysticksPerPlayer : this._maxControllersPerPlayer;

    private bool ShowAssignedControllers() => this._showControllers && (this._showAssignedControllers || this.GetMaxControllersPerPlayer() != 1);
    ...
    public static LanguageData GetLanguage() => (UnityEngine.Object) Rewired.UI.ControlMapper.ControlMapper.Instance == (UnityEngine.Object) null ? (LanguageData) null : Rewired.UI.ControlMapper.ControlMapper.Instance._language;
    ...
    private abstract class GUIElement
    {
      ...
      public virtual void SetInteractible(bool state, bool playTransition) => this.SetInteractible(state, playTransition, false);
      ...
      public virtual string GetLabel() => (UnityEngine.Object) this.text == (UnityEngine.Object) null ? string.Empty : this.text.text;

      public virtual void AddChild(Rewired.UI.ControlMapper.ControlMapper.GUIElement child) => this.children.Add(child);
    ...
    private class GUIButton : Rewired.UI.ControlMapper.ControlMapper.GUIElement
    {
      ...
      public void SetButtonInfoData(string identifier, int intData) => this.SetElementInfoData(identifier, intData);
    ...
    public class MappingSet
    {
      ...
      public Rewired.UI.ControlMapper.ControlMapper.MappingSet.ActionListMode actionListMode => this._actionListMode;
      ...
      public bool isValid => this._mapCategoryId >= 0 && ReInput.mapping.GetMapCategory(this._mapCategoryId) != null;
      ...
      public static Rewired.UI.ControlMapper.ControlMapper.MappingSet Default => new Rewired.UI.ControlMapper.ControlMapper.MappingSet(0, Rewired.UI.ControlMapper.ControlMapper.MappingSet.ActionListMode.ActionCategory, new int[1], new int[0]);
    ...
    public class InputBehaviorSettings
    {
      ...
      public string joystickAxisSensitivityLabelLanguageKey => this._joystickAxisSensitivityLabelLanguageKey;

      public string mouseXYAxisSensitivityLabelLanguageKey => this._mouseXYAxisSensitivityLabelLanguageKey;
    ...
    private class InputMapping
    {
      ...
      public string elementName
      {
        get
        {
          if (this.controllerType == ControllerType.Keyboard && this.modifierKeyFlags != ModifierKeyFlags.None)
            return string.Format("{0} + {1}", (object) Keyboard.ModifierKeyFlagsToString(this.modifierKeyFlags), (object) this.pollingInfo.elementIdentifierName);
          string str = this.pollingInfo.elementIdentifierName;
          ...
          if (pollingInfo.elementType == ControllerElementType.Axis)
          {
            if (this.axisRange == AxisRange.Positive)
            {
              ...
              str = pollingInfo.elementIdentifier.positiveName;
            }
            else if (this.axisRange == AxisRange.Negative)
            {
              pollingInfo = this.pollingInfo;
              str = pollingInfo.elementIdentifier.negativeName;
            }
          }
          return str;
        }
      ...
      public ElementAssignment ToElementAssignment()
      {
        ...
        int num = this.fieldInfo.axisRange == AxisRange.Negative ? 1 : 0;
        int elementMapId = this.aem != null ? this.aem.id : -1;
        return new ElementAssignment((ControllerType) controllerType, (ControllerElementType) elementType, elementIdentifierId, (AxisRange) axisRange, (KeyCode) keyboardKey, (ModifierKeyFlags) modifierKeyFlags, actionId, (Pole) num, false, elementMapId);
      }
    }
    ...
    private class IndexedDictionary<TKey, TValue>
    {
      ...
      public IndexedDictionary() => this.list = new List<Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<TKey, TValue>.Entry>();
    ...
    private class InputGrid
    {
      ...
      public void AddAction(int mapCategoryId, InputAction action, AxisRange axisRange) => this.list.AddAction(mapCategoryId, action, axisRange);

      public void AddActionCategory(int mapCategoryId, int actionCategoryId) => this.list.AddActionCategory(mapCategoryId, actionCategoryId);
      ...
      public void SetColumnHeight(int mapCategoryId, float height) => this.list.SetColumnHeight(mapCategoryId, height);

      public float GetColumnHeight(int mapCategoryId) => this.list.GetColumnHeight(mapCategoryId);

      public void SetFieldsActive(int mapCategoryId, bool state) => this.list.SetFieldsActive(mapCategoryId, state);
    ...
    private class InputGridEntryList
    {
      ...
      public InputGridEntryList() => this.entries = new Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.MapCategoryEntry>();
      ...
      public void AddAction(int mapCategoryId, InputAction action, AxisRange axisRange) => this.AddActionEntry(mapCategoryId, action, axisRange);
      ...
      public void AddActionCategory(int mapCategoryId, int actionCategoryId) => this.AddActionCategoryEntry(mapCategoryId, actionCategoryId);
      ...
      public bool Contains(int mapCategoryId, int actionId, AxisRange axisRange) => this.GetActionEntry(mapCategoryId, actionId, axisRange) != null;
      ...
      private class MapCategoryEntry
      {
        ...
        public List<Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionEntry> actionList => this._actionList;

        public Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionCategoryEntry> actionCategoryList => this._actionCategoryList;
        ...
        public bool ContainsActionEntry(int actionId, AxisRange axisRange) => this.IndexOfActionEntry(actionId, axisRange) >= 0;
      ...
      private class ActionEntry
      {
        ...
        public void SetLabel(Rewired.UI.ControlMapper.ControlMapper.GUILabel label) => this.label = label;

        public bool Matches(int actionId, AxisRange axisRange) => this.action.id == actionId && this.axisRange == axisRange;
        ...
        public bool Contains(ControllerType controllerType, int fieldId) => this.fieldSets.ContainsKey((int) controllerType) && this.fieldSets.Get((int) controllerType).fields.ContainsKey(fieldId);
    ...
    public class WindowManager
    {
      ...
      public bool IsFocused(int windowId) => windowId >= 0 && !((UnityEngine.Object) this.topWindow == (UnityEngine.Object) null) && this.topWindow.id == windowId;
