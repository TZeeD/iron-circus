...
namespace Rewired.UI.ControlMapper
{
  ...
  public class InputBehaviorWindow : Window
  {
    ...
    private void JoystickAxisSensitivityCanceled(int inputBehaviorId, int controlId) => this.GetInputBehaviorInfo(inputBehaviorId)?.RestoreData(InputBehaviorWindow.PropertyType.JoystickAxisSensitivity, controlId);

    private void MouseXYAxisSensitivityCanceled(int inputBehaviorId, int controlId) => this.GetInputBehaviorInfo(inputBehaviorId)?.RestoreData(InputBehaviorWindow.PropertyType.MouseXYAxisSensitivity, controlId);
    ...
    private InputBehavior GetInputBehavior(int id) => ReInput.mapping.GetInputBehavior(this.playerId, id);
