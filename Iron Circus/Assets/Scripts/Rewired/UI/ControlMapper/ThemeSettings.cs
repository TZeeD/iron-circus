...
namespace Rewired.UI.ControlMapper
{
  ...
  public class ThemeSettings : ScriptableObject
  {
    ...
    private void Apply(string themeClass, Text item)
    {
      if ((UnityEngine.Object) item == (UnityEngine.Object) null)
        return;
      ThemeSettings.TextSettings textSettings = themeClass == "button" ? this._buttonTextSettings : (themeClass == "inputGridField" ? this._inputGridFieldTextSettings : this._textSettings);
    ...
    private struct CustomColorBlock
    {
      ...
      public static implicit operator ColorBlock(ThemeSettings.CustomColorBlock item) => new ColorBlock()
      {
    ...
    private struct CustomSpriteState
    {
      ...
      public static implicit operator SpriteState(ThemeSettings.CustomSpriteState item) => new SpriteState()
      {
