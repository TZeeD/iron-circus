...
namespace Rewired.UI.ControlMapper
{
  ...
  public class CustomSlider : Slider, ICustomSelectable, ICancelHandler, IEventSystemHandler
  {
    ...
    public override Selectable FindSelectableOnLeft() => (this.navigation.mode & Navigation.Mode.Horizontal) != Navigation.Mode.None || this._autoNavLeft ? UISelectionUtility.FindNextSelectable((Selectable) this, this.transform, Vector3.left) : base.FindSelectableOnLeft();

    public override Selectable FindSelectableOnRight() => (this.navigation.mode & Navigation.Mode.Horizontal) != Navigation.Mode.None || this._autoNavRight ? UISelectionUtility.FindNextSelectable((Selectable) this, this.transform, Vector3.right) : base.FindSelectableOnRight();

    public override Selectable FindSelectableOnUp() => (this.navigation.mode & Navigation.Mode.Vertical) != Navigation.Mode.None || this._autoNavUp ? UISelectionUtility.FindNextSelectable((Selectable) this, this.transform, Vector3.up) : base.FindSelectableOnUp();

    public override Selectable FindSelectableOnDown() => (this.navigation.mode & Navigation.Mode.Vertical) != Navigation.Mode.None || this._autoNavDown ? UISelectionUtility.FindNextSelectable((Selectable) this, this.transform, Vector3.down) : base.FindSelectableOnDown();
