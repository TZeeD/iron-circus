...
namespace Rewired.UI.ControlMapper
{
  ...
  public class CalibrationWindow : Window
  {
    ...
    private bool axisSelected => this.joystick != null && this.selectedAxis >= 0 && this.selectedAxis < this.joystick.calibrationMap.axisCount;

    private AxisCalibration axisCalibration => !this.axisSelected ? (AxisCalibration) null : this.joystick.calibrationMap.GetAxis(this.selectedAxis);
    ...
    private float GetSliderSensitivity(AxisCalibration axisCalibration) => axisCalibration.sensitivityType == AxisSensitivityType.Multiplier || axisCalibration.sensitivityType != AxisSensitivityType.Power ? axisCalibration.sensitivity : CalibrationWindow.ProcessPowerValue(axisCalibration.sensitivity, 0.0f, this.sensitivitySlider.maxValue);
