...
namespace Rewired.Integration.UnityUI
{
  public abstract class RewiredPointerInputModule : BaseInputModule
  {
    ...
    protected virtual void ProcessMove(PlayerPointerEventData pointerEvent)
    {
      ...
      {
        newEnterTarget = this.GetMouseInputSource(pointerEvent.playerId, pointerEvent.inputSourceIndex).locked ? (GameObject) null : pointerEvent.pointerCurrentRaycast.gameObject;
      }
      else
      {
      ...
      this.HandlePointerExitAndEnter((PointerEventData) pointerEvent, newEnterTarget);
    }
