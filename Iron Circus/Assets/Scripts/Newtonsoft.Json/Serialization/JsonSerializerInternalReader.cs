  ...
  internal class JsonSerializerInternalReader : JsonSerializerInternalBase
  {
      ...
      string id)
    {
      ...
      else
      {
        ...
        obj = this.PopulateList(contract1.ShouldCreateWrapper || !(existingValue is IList) ? (IList) contract1.CreateWrapper(existingValue) : (IList) existingValue, reader, contract1, member, id);
      }
      return obj;
    }
              ...
              if (jsonContract.ContractType == JsonContractType.Array)
              {
                ...
                if (jsonArrayContract.CanDeserialize && !jsonArrayContract.IsReadOnlyOrFixedSize)
                {
                  ...
                  if (list1 != null)
                  {
                    ...
                    foreach (object obj3 in jsonArrayContract.ShouldCreateWrapper ? (IEnumerable) jsonArrayContract.CreateWrapper(obj2) : (IEnumerable) obj2)
                      list2.Add(obj3);
                  }
                }
              }
