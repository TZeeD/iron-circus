...
namespace UnityEngine.PostProcessing
{
  public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
  {
    ...
    private Vector3 CIExyToLMS(float x, float y)
    {
      ...
      double num4 = 0.732800006866455 * (double) num2 + 0.42960000038147 * (double) num1 - 0.162400007247925 * (double) num3;
      float num5 = (float) (-0.703599989414215 * (double) num2 + 1.69749999046326 * (double) num1 + 0.00609999988228083 * (double) num3);
      float num6 = (float) (3.0 / 1000.0 * (double) num2 + 0.0136000001803041 * (double) num1 + 0.983399987220764 * (double) num3);
      double num7 = (double) num5;
      double num8 = (double) num6;
      return new Vector3((float) num4, (float) num7, (float) num8);
    }
    ...
    public static Vector3 GetLiftValue(Color lift)
    {
      ...
      double num2 = ((double) color.r - (double) num1) * 0.100000001490116 + (double) lift.a;
      float num3 = (float) (((double) color.g - (double) num1) * 0.100000001490116) + lift.a;
      float num4 = (float) (((double) color.b - (double) num1) * 0.100000001490116) + lift.a;
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), -1f, 1f);
    }
    ...
    public static Vector3 GetGammaValue(Color gamma)
    {
      ...
      double num2 = 1.0 / (double) Mathf.Max(0.01f, b1);
      float num3 = 1f / Mathf.Max(0.01f, b2);
      float num4 = 1f / Mathf.Max(0.01f, b3);
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), 0.0f, 5f);
    }
    ...
    public static Vector3 GetGainValue(Color gain)
    {
      ...
      double num2 = (double) Mathf.Pow(2f, (float) (((double) color.r - (double) num1) * 0.5)) + (double) gain.a;
      float num3 = Mathf.Pow(2f, (float) (((double) color.g - (double) num1) * 0.5)) + gain.a;
      float num4 = Mathf.Pow(2f, (float) (((double) color.b - (double) num1) * 0.5)) + gain.a;
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), 0.0f, 4f);
    }
    ...
    public static Vector3 GetSlopeValue(Color slope)
    {
      ...
      float num1 = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      slope.a *= 0.5f;
      double num2 = ((double) color.r - (double) num1) * 0.100000001490116 + (double) slope.a + 1.0;
      float num3 = (float) (((double) color.g - (double) num1) * 0.100000001490116 + (double) slope.a + 1.0);
      float num4 = (float) (((double) color.b - (double) num1) * 0.100000001490116 + (double) slope.a + 1.0);
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), 0.0f, 2f);
    }
    ...
    public static Vector3 GetPowerValue(Color power)
    {
      ...
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), 0.5f, 2.5f);
    }
    ...
    public static Vector3 GetOffsetValue(Color offset)
    {
      ...
      float num1 = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      offset.a *= 0.5f;
      double num2 = ((double) color.r - (double) num1) * 0.0500000007450581 + (double) offset.a;
      float num3 = (float) (((double) color.g - (double) num1) * 0.0500000007450581) + offset.a;
      float num4 = (float) (((double) color.b - (double) num1) * 0.0500000007450581) + offset.a;
      double num5 = (double) num3;
      double num6 = (double) num4;
      return ColorGradingComponent.ClampVector(new Vector3((float) num2, (float) num5, (float) num6), -0.8f, 0.8f);
    }
