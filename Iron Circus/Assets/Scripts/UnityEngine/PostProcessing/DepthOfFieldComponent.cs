...
namespace UnityEngine.PostProcessing
{
  public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
  {
    ...
    public override bool active => this.model.enabled && SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf) && !this.context.interrupted;
      ...
      float taaBlending)
    {
      ...
      RenderTexture renderTexture1 = this.context.renderTextureFactory.Get(this.context.width, this.context.height, format: format2);
      ...
      RenderTexture dest = this.context.renderTextureFactory.Get(this.context.width / 2, this.context.height / 2, format: format1);
      mat.SetTexture(DepthOfFieldComponent.Uniforms._CoCTex, (Texture) renderTexture1);
