...
namespace UnityEngine.PostProcessing
{
  ...
  {
    private const string k_ShaderString = "Hidden/Post FX/Builtin DebugView Views";
    ...
    public override string GetName() => "Builtin DebugView Views";

    public override void PopulateCommandBuffer(CommandBuffer cb)
    {
      BuiltinDebugViewsModel.Settings settings = this.model.settings;
      Material material = this.context.materialFactory.Get("Hidden/Post FX/Builtin DebugView Views");
    ...
    {
      Material mat = this.context.materialFactory.Get("Hidden/Post FX/Builtin DebugView Views");
