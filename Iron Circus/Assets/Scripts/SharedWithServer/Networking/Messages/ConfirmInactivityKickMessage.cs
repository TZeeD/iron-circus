...
// Type: SharedWithServer.Networking.Messages.ConfirmInactivityKickMessage
...
namespace SharedWithServer.Networking.Messages
{
  ...
  {
    public ConfirmInactivityKickMessage()
      : base(RumpfieldMessageType.ConfirmInactivityKick)
    {
    }
