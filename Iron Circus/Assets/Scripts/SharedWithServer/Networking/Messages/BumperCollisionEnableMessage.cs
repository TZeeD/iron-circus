...
// Type: SharedWithServer.Networking.Messages.BumperCollisionEnableMessage
...
namespace SharedWithServer.Networking.Messages
{
  public class BumperCollisionEnableMessage : Message
  {
    ...
    public BumperCollisionEnableMessage()
      : base(RumpfieldMessageType.BumperCollisionEnable)
    {
    }

    public BumperCollisionEnableMessage(UniqueId[] newBumperIds)
      : base(RumpfieldMessageType.BumperCollisionEnable)
    {
