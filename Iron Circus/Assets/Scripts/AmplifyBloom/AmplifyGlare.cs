      ...
      if (this.m_isDirty || this.m_currentWidth != source.width || this.m_currentHeight != source.height)
      {
        ...
        for (int index4 = 0; index4 < starDefData.StarlinesCount; ++index4)
        {
          ...
          for (int index5 = 0; index5 < num1; ++index5)
          {
            ...
            {
              float num7 = Mathf.Pow(starLineData.Attenuation, num6 * (float) index6);
              this.m_amplifyGlareCache.Starlines[index4].Passes[index5].Weights[index6] = this.m_amplifyGlareCache.CromaticAberrationMat[num1 - 1 - index5, index6] * num7 * ((float) index5 + 1f) * 0.5f;
              ...
              if ((double) Mathf.Abs(this.m_amplifyGlareCache.Starlines[index4].Passes[index5].Offsets[index6].x) >= 0.899999976158142 || (double) Mathf.Abs(this.m_amplifyGlareCache.Starlines[index4].Passes[index5].Offsets[index6].y) >= 0.899999976158142)
              {
