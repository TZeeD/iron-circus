Shader "SteelCircus/FX/ArenaSpaceAudienceBackgroundShader" {
	Properties {
	...
	SubShader {
		...
		Pass {
			Name "FORWARD"
			LOD 200
			Tags { "DisableBatching" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent-1" "RenderType" = "Transparent" }
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					uniform  sampler2D _TintMaskTex;
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_TintMaskTex, vs_TEXCOORD0.xy);
					    u_xlat2 = texture(_MainTex, vs_TEXCOORD0.zw);
					    u_xlat2.xyz = u_xlat1.xyz * u_xlat2.xyz;
					    u_xlat2.xyz = u_xlat2.xyz * _Color.xyz;
					    u_xlat3.xyz = u_xlat1.xyz * _Specular.xyz;
					    SV_Target0.w = u_xlat1.w * 10.0;
					    ...
					    u_xlat40 = dot((-u_xlat0.xyz), vs_TEXCOORD1.xyz);
					    u_xlat40 = u_xlat40 + u_xlat40;
					    u_xlat5.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat40)) + (-u_xlat0.xyz);
					    ...
					    if(u_xlatb41){
					        ...
					        if(u_xlatb41){
					            ...
					            u_xlat5.xyz = u_xlat9.xyz * vec3(u_xlat41) + u_xlat10.xyz;
					        }
					        ...
					        u_xlat7.xyz = vec3(u_xlat40) * u_xlat7.xyz + (-u_xlat5.xyz);
					    ...
					    u_xlat39 = max(u_xlat3.z, u_xlat39);
					    u_xlat39 = (-u_xlat39) + 1.0;
					    u_xlat40 = dot(u_xlat0.xyz, u_xlat5.xyz);
					    u_xlat41 = u_xlat40 + u_xlat40;
					    u_xlat0.xyz = u_xlat5.xyz * (-vec3(u_xlat41)) + u_xlat0.xyz;
					    u_xlat41 = dot(u_xlat5.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat41 = clamp(u_xlat41, 0.0, 1.0);
					    u_xlat40 = u_xlat40;
					    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
					    u_xlat5.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat5.y = (-u_xlat40) + 1.0;
					    u_xlat5.zw = u_xlat5.xy * u_xlat5.xy;
					    u_xlat0.xy = u_xlat5.xy * u_xlat5.xw;
					    u_xlat4.yz = u_xlat5.zy * u_xlat0.xy;
					    u_xlat0.x = (-u_xlat39) + _Glossiness;
					    u_xlat0.x = u_xlat0.x + 1.0;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat5 = texture(unity_NHxRoughness, u_xlat4.yw);
					    u_xlat13.x = u_xlat5.x * 16.0;
					    u_xlat4.xyw = u_xlat3.xyz * u_xlat13.xxx;
					    u_xlat13.xyz = u_xlat2.xyz * vec3(u_xlat39) + u_xlat4.xyw;
					    u_xlat2.xyz = vec3(u_xlat41) * u_xlat6.xyz;
					    u_xlat1.xyz = (-_Specular.xyz) * u_xlat1.xyz + u_xlat0.xxx;
					    u_xlat1.xyz = u_xlat4.zzz * u_xlat1.xyz + u_xlat3.xyz;
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = texture(_TintMaskTex, vs_TEXCOORD0.xy);
					    u_xlat3 = texture(_MainTex, vs_TEXCOORD0.zw);
					    u_xlat3.xyz = u_xlat2.xyz * u_xlat3.xyz;
					    u_xlat3.xyz = u_xlat3.xyz * _Color.xyz;
					    u_xlat4.xyz = u_xlat2.xyz * _Specular.xyz;
					    SV_Target0.w = u_xlat2.w * 10.0;
					    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
					    ...
					    u_xlat8.xy = (-vec2(u_xlat41)) * vec2(0.699999988, 0.0799999982) + vec2(1.70000005, 0.600000024);
					    u_xlat40 = u_xlat41 * u_xlat8.x;
					    ...
					    u_xlat8.xzw = u_xlat7.xyz * vec3(u_xlat42);
					    ...
					    u_xlat27 = u_xlat41 * u_xlat41 + 0.5;
					    ...
					    u_xlat13 = (-u_xlat13) * u_xlat8.y + 1.0;
					    u_xlat26 = (-u_xlat40) + _Glossiness;
					    u_xlat26 = u_xlat26 + 1.0;
					    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
					    u_xlat5.xyz = u_xlat4.xyz * u_xlat0.xxx;
					    u_xlat14.xyz = u_xlat3.xyz * vec3(u_xlat40) + u_xlat5.xyz;
					    u_xlat14.xyz = u_xlat6.xyz * u_xlat14.xyz;
					    u_xlat3.xyz = u_xlat8.xzw * vec3(u_xlat13);
					    u_xlat0.x = (-u_xlat1.x) + 1.0;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(u_xlat26);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat2.xyz + u_xlat4.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * u_xlat3.xyz;
					    SV_Target0.xyz = u_xlat14.xyz * vec3(u_xlat39) + u_xlat0.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    u_xlat7.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
					    ...
					    u_xlat1.xyw = (-_Specular.xyz) * u_xlat2.xyz + u_xlat1.xxx;
					    u_xlat1.xyz = vec3(u_xlat27) * u_xlat1.xyw + u_xlat4.xyz;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xw = (-vec2(_Glossiness)) + vec2(1.0, 1.0);
					    u_xlat44 = dot((-u_xlat0.xyz), vs_TEXCOORD1.xyz);
					    u_xlat44 = u_xlat44 + u_xlat44;
					    u_xlat5.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat44)) + (-u_xlat0.xyz);
					    ...
					    if(u_xlatb42){
					        ...
					        u_xlat7.xyz = (bool(u_xlatb42)) ? u_xlat7.xyz : vs_TEXCOORD2.xyz;
					    ...
					    if(u_xlatb44){
					        ...
					        if(u_xlatb44){
					            ...
					            u_xlat5.xyz = u_xlat10.xyz * vec3(u_xlat44) + u_xlat11.xyz;
					        }
					        u_xlat5 = textureLod(unity_SpecCube1, u_xlat5.xyz, u_xlat42);
					    ...
					    u_xlat42 = max(u_xlat3.y, u_xlat3.x);
					    u_xlat42 = max(u_xlat3.z, u_xlat42);
					    u_xlat42 = (-u_xlat42) + 1.0;
					    u_xlat2.xyz = vec3(u_xlat42) * u_xlat2.xyz;
					    u_xlat43 = dot(u_xlat0.xyz, u_xlat5.xyz);
					    u_xlat44 = u_xlat43 + u_xlat43;
					    u_xlat0.xyz = u_xlat5.xyz * (-vec3(u_xlat44)) + u_xlat0.xyz;
					    ...
					    u_xlat0.xy = u_xlat5.xy * u_xlat5.xw;
					    u_xlat4.yz = u_xlat5.zy * u_xlat0.xy;
					    u_xlat0.x = (-u_xlat42) + _Glossiness;
					    u_xlat0.x = u_xlat0.x + 1.0;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat5 = texture(unity_NHxRoughness, u_xlat4.yw);
					    u_xlat14.x = u_xlat5.x * 16.0;
					    u_xlat14.xyz = u_xlat14.xxx * u_xlat3.xyz + u_xlat2.xyz;
					    u_xlat4.xyw = vec3(u_xlat44) * u_xlat6.xyz;
					    u_xlat1.xyz = (-_Specular.xyz) * u_xlat1.xyz + u_xlat0.xxx;
					    u_xlat1.xyz = u_xlat4.zzz * u_xlat1.xyz + u_xlat3.xyz;
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat9.xyz;
					    u_xlat1.xyz = u_xlat7.xyz * u_xlat2.xyz + u_xlat1.xyz;
					    SV_Target0.xyz = u_xlat14.xyz * u_xlat4.xyw + u_xlat1.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat9.xy = (-vec2(u_xlat45)) * vec2(0.699999988, 0.0799999982) + vec2(1.70000005, 0.600000024);
					    u_xlat43 = u_xlat45 * u_xlat9.x;
					    ...
					    u_xlat9.xzw = u_xlat8.xyz * vec3(u_xlat44);
					    ...
					    u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
					    u_xlat44 = dot(u_xlat5.xyz, u_xlat0.xyz);
					    u_xlat44 = clamp(u_xlat44, 0.0, 1.0);
					    u_xlat1.x = dot(u_xlat5.xyz, u_xlat1.xyz);
					    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
					    u_xlat0.x = dot(_WorldSpaceLightPos0.xyz, u_xlat0.xyz);
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat14 = u_xlat45 * u_xlat45;
					    u_xlat28 = u_xlat14 * u_xlat14;
					    u_xlat15.x = u_xlat44 * u_xlat44;
					    u_xlat29 = u_xlat14 * u_xlat14 + -1.0;
					    u_xlat15.x = u_xlat15.x * u_xlat29 + 1.00001001;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = max(u_xlat0.x, 0.100000001);
					    u_xlat29 = u_xlat45 * u_xlat45 + 0.5;
					    u_xlat0.x = u_xlat0.x * u_xlat29;
					    u_xlat15.x = u_xlat15.x * u_xlat15.x;
					    u_xlat0.x = u_xlat0.x * u_xlat15.x;
					    u_xlat0.x = u_xlat0.x * 4.0;
					    u_xlat0.x = u_xlat28 / u_xlat0.x;
					    u_xlat14 = u_xlat45 * u_xlat14;
					    u_xlat14 = (-u_xlat14) * u_xlat9.y + 1.0;
					    u_xlat28 = (-u_xlat43) + _Glossiness;
					    u_xlat28 = u_xlat28 + 1.0;
					    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
					    u_xlat15.xyz = u_xlat0.xxx * u_xlat4.xyz + u_xlat3.xyz;
					    u_xlat15.xyz = u_xlat6.xyz * u_xlat15.xyz;
					    u_xlat3.xyz = u_xlat3.xyz * u_xlat7.xyz;
					    u_xlat15.xyz = u_xlat15.xyz * vec3(u_xlat42) + u_xlat3.xyz;
					    u_xlat0.xyw = u_xlat9.xzw * vec3(u_xlat14);
					    u_xlat1.x = (-u_xlat1.x) + 1.0;
					    u_xlat1.x = u_xlat1.x * u_xlat1.x;
					    u_xlat1.x = u_xlat1.x * u_xlat1.x;
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(u_xlat28);
					    u_xlat2.xyz = u_xlat1.xxx * u_xlat2.xyz + u_xlat4.xyz;
					    SV_Target0.xyz = u_xlat0.xyw * u_xlat2.xyz + u_xlat15.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyw = (-_Specular.xyz) * u_xlat2.xyz + u_xlat1.xxx;
					    u_xlat1.xyz = vec3(u_xlat29) * u_xlat1.xyw + u_xlat4.xyz;
					    SV_Target0.xyz = u_xlat3.xyz * u_xlat1.xyz + u_xlat0.xyw;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
					    u_xlat4.xw = (-vec2(_Glossiness)) + vec2(1.0, 1.0);
					    u_xlat39 = dot((-u_xlat0.xyz), vs_TEXCOORD1.xyz);
					    u_xlat39 = u_xlat39 + u_xlat39;
					    u_xlat5.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat39)) + (-u_xlat0.xyz);
					    ...
					    u_xlat5 = texture(unity_NHxRoughness, u_xlat4.yw);
					    u_xlat13.x = u_xlat5.x * 16.0;
					    u_xlat13.xyz = u_xlat13.xxx * u_xlat3.xyz + u_xlat2.xyz;
					    u_xlat4.xyw = vec3(u_xlat41) * _LightColor0.xyz;
					    u_xlat1.xyz = (-_Specular.xyz) * u_xlat1.xyz + u_xlat0.xxx;
					    u_xlat1.xyz = u_xlat4.zzz * u_xlat1.xyz + u_xlat3.xyz;
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat8.xyz;
					    u_xlat1.xyz = u_xlat6.xyz * u_xlat2.xyz + u_xlat1.xyz;
					    SV_Target0.xyz = u_xlat13.xyz * u_xlat4.xyw + u_xlat1.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat8.xy = (-u_xlat27.yy) * vec2(0.699999988, 0.0799999982) + vec2(1.70000005, 0.600000024);
					    u_xlat41 = u_xlat27.y * u_xlat8.x;
					    ...
					    u_xlat41 = max(u_xlat4.y, u_xlat4.x);
					    u_xlat41 = max(u_xlat4.z, u_xlat41);
					    ...
					    u_xlat0.x = dot(_WorldSpaceLightPos0.xyz, u_xlat0.xyz);
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat0.y = u_xlat27.y * u_xlat27.y;
					    u_xlat26 = u_xlat0.y * u_xlat0.y;
					    u_xlat14.x = u_xlat42 * u_xlat42;
					    u_xlat27.x = u_xlat0.y * u_xlat0.y + -1.0;
					    u_xlat14.x = u_xlat14.x * u_xlat27.x + 1.00001001;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = max(u_xlat0.x, 0.100000001);
					    u_xlat27.x = u_xlat27.y * u_xlat27.y + 0.5;
					    u_xlat0.xy = u_xlat27.xy * u_xlat0.xy;
					    u_xlat14.x = u_xlat14.x * u_xlat14.x;
					    u_xlat0.x = u_xlat0.x * u_xlat14.x;
					    u_xlat0.x = u_xlat0.x * 4.0;
					    u_xlat0.x = u_xlat26 / u_xlat0.x;
					    u_xlat13 = (-u_xlat0.y) * u_xlat8.y + 1.0;
					    u_xlat26 = (-u_xlat41) + _Glossiness;
					    u_xlat26 = u_xlat26 + 1.0;
					    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
					    u_xlat14.xyz = u_xlat0.xxx * u_xlat4.xyz + u_xlat3.xyz;
					    u_xlat14.xyz = u_xlat14.xyz * _LightColor0.xyz;
					    u_xlat3.xyz = u_xlat3.xyz * u_xlat6.xyz;
					    u_xlat14.xyz = u_xlat14.xyz * vec3(u_xlat39) + u_xlat3.xyz;
					    u_xlat0.xyw = u_xlat8.xzw * vec3(u_xlat13);
					    u_xlat1.x = (-u_xlat1.x) + 1.0;
					    u_xlat1.x = u_xlat1.x * u_xlat1.x;
					    u_xlat1.x = u_xlat1.x * u_xlat1.x;
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(u_xlat26);
					    u_xlat2.xyz = u_xlat1.xxx * u_xlat2.xyz + u_xlat4.xyz;
					    SV_Target0.xyz = u_xlat0.xyw * u_xlat2.xyz + u_xlat14.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb44){
					        ...
					        u_xlat42 = u_xlat42 * unity_SpecCube1_HDR.x;
					        u_xlat5.xyz = u_xlat5.xyz * vec3(u_xlat42);
					        u_xlat7.xyz = vec3(u_xlat43) * u_xlat7.xyz + (-u_xlat5.xyz);
					        u_xlat8.xyz = unity_SpecCube0_BoxMin.www * u_xlat7.xyz + u_xlat5.xyz;
					    }
					    u_xlat42 = dot(vs_TEXCOORD1.xyz, vs_TEXCOORD1.xyz);
					    u_xlat42 = inversesqrt(u_xlat42);
					    u_xlat5.xyz = vec3(u_xlat42) * vs_TEXCOORD1.xyz;
					    u_xlat42 = max(u_xlat4.y, u_xlat4.x);
					    u_xlat42 = max(u_xlat4.z, u_xlat42);
					    u_xlat42 = (-u_xlat42) + 1.0;
					    ...
					    u_xlat43 = abs(u_xlat39) * u_xlat40 + u_xlat26;
					    ...
					    u_xlat43 = u_xlat14 * u_xlat40 + (-u_xlat14);
					    ...
					    u_xlat1.x = u_xlatb1 ? 1.0 : float(0.0);
					    u_xlat39 = u_xlat39 * u_xlat1.x;
					    u_xlat1.x = (-u_xlat42) + _Glossiness;
					    u_xlat1.x = u_xlat1.x + 1.0;
					    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb39){
					        ...
					        u_xlat6.xyz = (bool(u_xlatb39)) ? u_xlat6.xyz : vs_TEXCOORD2.xyz;
					    ...
					    u_xlat39 = vs_TEXCOORD1.y * vs_TEXCOORD1.y;
					    u_xlat39 = vs_TEXCOORD1.x * vs_TEXCOORD1.x + (-u_xlat39);
					    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat39) + u_xlat8.xyz;
					    u_xlat6.xyz = u_xlat6.xyz + u_xlat7.xyz;
					    u_xlat6.xyz = max(u_xlat6.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat7 = texture(unity_Lightmap, vs_TEXCOORD3.xy);
					    u_xlat39 = log2(u_xlat7.w);
					    u_xlat39 = u_xlat39 * unity_Lightmap_HDR.y;
					    u_xlat39 = exp2(u_xlat39);
					    u_xlat39 = u_xlat39 * unity_Lightmap_HDR.x;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat37 = dot((-u_xlat0.xyz), vs_TEXCOORD1.xyz);
					    u_xlat37 = u_xlat37 + u_xlat37;
					    u_xlat4.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat37)) + (-u_xlat0.xyz);
					    ...
					    if(u_xlatb38){
					        ...
					        u_xlat4 = textureLod(unity_SpecCube1, u_xlat4.xyz, u_xlat36);
					    ...
					    u_xlat12.x = u_xlat12.x + _Glossiness;
					    u_xlat12.x = clamp(u_xlat12.x, 0.0, 1.0);
					    u_xlat12.xyz = (-_Specular.xyz) * u_xlat1.xyz + u_xlat12.xxx;
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat7.xy = (-vec2(u_xlat36)) * vec2(0.699999988, 0.0799999982) + vec2(1.70000005, 0.600000024);
					    ...
					    u_xlat7.xzw = u_xlat6.xyz * vec3(u_xlat38);
					    ...
					    if(u_xlatb39){
					        ...
					        u_xlat7.xzw = unity_SpecCube0_BoxMin.www * u_xlat6.xyz + u_xlat4.xyz;
					    }
					    ...
					    u_xlat12.x = (-u_xlat12.x) * u_xlat7.y + 1.0;
					    u_xlat24 = (-u_xlat37) + _Glossiness;
					    u_xlat24 = u_xlat24 + 1.0;
					    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
					    u_xlat4.xyz = u_xlat7.xzw * u_xlat12.xxx;
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat12.xyz = (-_Specular.xyz) * u_xlat1.xyz + vec3(u_xlat24);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat12.xyz + u_xlat3.xyz;
				...
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    u_xlat24 = u_xlat24 + 1.0;
					    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
					    u_xlat4.xyz = u_xlat7.xyz * u_xlat12.xxx;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat12.x = u_xlat0.x * u_xlat12.x;
					    u_xlat0.x = u_xlat0.x * u_xlat12.x;
					    u_xlat12.x = (-u_xlat36) + _Glossiness;
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat13 = u_xlat41 * u_xlat13;
					    u_xlat13 = (-u_xlat13) * u_xlat8.y + 1.0;
					    u_xlat26 = (-u_xlat40) + 1.0;
					    u_xlat26 = u_xlat26 + _Glossiness;
					    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
					    u_xlat5.xyz = u_xlat4.xyz * u_xlat0.xxx;
					    u_xlat14.xyz = u_xlat3.xyz * vec3(u_xlat40) + u_xlat5.xyz;
					    u_xlat14.xyz = u_xlat6.xyz * u_xlat14.xyz;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat9.xyz;
					    u_xlat1.xyz = u_xlat7.xyz * u_xlat2.xyz + u_xlat1.xyz;
					    u_xlat0.xyz = u_xlat14.xyz * u_xlat4.xyw + u_xlat1.xyz;
					    u_xlat42 = vs_TEXCOORD4 / _ProjectionParams.y;
					    u_xlat42 = (-u_xlat42) + 1.0;
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(u_xlat28);
					    u_xlat2.xyz = u_xlat1.xxx * u_xlat2.xyz + u_xlat4.xyz;
					    u_xlat0.xyz = u_xlat0.xyw * u_xlat2.xyz + u_xlat15.xyz;
					    u_xlat42 = vs_TEXCOORD4 / _ProjectionParams.y;
					    u_xlat42 = (-u_xlat42) + 1.0;
					    u_xlat42 = u_xlat42 * _ProjectionParams.z;
					    u_xlat42 = max(u_xlat42, 0.0);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat8.xyz;
					    u_xlat1.xyz = u_xlat6.xyz * u_xlat2.xyz + u_xlat1.xyz;
					    u_xlat0.xyz = u_xlat13.xyz * u_xlat4.xyw + u_xlat1.xyz;
					    u_xlat39 = vs_TEXCOORD4 / _ProjectionParams.y;
					    u_xlat39 = (-u_xlat39) + 1.0;
					    u_xlat39 = u_xlat39 * _ProjectionParams.z;
					    u_xlat39 = max(u_xlat39, 0.0);
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(u_xlat26);
					    u_xlat2.xyz = u_xlat1.xxx * u_xlat2.xyz + u_xlat4.xyz;
					    u_xlat0.xyz = u_xlat0.xyw * u_xlat2.xyz + u_xlat14.xyz;
					    u_xlat39 = vs_TEXCOORD4 / _ProjectionParams.y;
					    u_xlat39 = (-u_xlat39) + 1.0;
					    u_xlat39 = u_xlat39 * _ProjectionParams.z;
					    u_xlat39 = max(u_xlat39, 0.0);
		...
		Pass {
			Name "FORWARD"
			LOD 200
			Tags { "DisableBatching" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Transparent-1" "RenderType" = "Transparent" }
			...
			Program "fp" {
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat12 = u_xlat7 * u_xlat12 + 1.00001001;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = max(u_xlat0.x, 0.100000001);
				...
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb25){
					        ...
					        u_xlat7.xyz = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD2.zzz + u_xlat7.xyz;
					        u_xlat7.xyz = u_xlat7.xyz + unity_ProbeVolumeWorldToObject[3].xyz;
					        u_xlat7.xyz = (bool(u_xlatb25)) ? u_xlat7.xyz : vs_TEXCOORD2.xyz;
					        u_xlat7.xyz = u_xlat7.xyz + (-unity_ProbeVolumeMin.xyz);
					        u_xlat7.yzw = u_xlat7.xyz * unity_ProbeVolumeSizeInv.xyz;
					    ...
					    u_xlat25 = inversesqrt(u_xlat25);
					    u_xlat7.xyz = vec3(u_xlat25) * vs_TEXCOORD1.xyz;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = u_xlat1.xyz * u_xlat2.xyz;
					    u_xlat2.xyz = u_xlat2.xyz * _Color.xyz;
					    u_xlat1.xyz = u_xlat1.xyz * _Specular.xyz;
					    SV_Target0.w = u_xlat1.w * 10.0;
					    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
				...
				SubProgram "d3d11 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat10 = u_xlat17 * u_xlat10 + 1.00001001;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat0.x = max(u_xlat0.x, 0.100000001);
				...
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = (-_Specular.xyz) * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
				...
				SubProgram "d3d11 hw_tier02 " {
					...
					void main()
					{
					    ...
					    SV_Target0.w = u_xlat2.w * 10.0;
					    SV_Target0.w = clamp(SV_Target0.w, 0.0, 1.0);
					    u_xlat5.xy = vs_TEXCOORD2.yy * unity_WorldToLight[1].xy;
					    u_xlat5.xy = unity_WorldToLight[0].xy * vs_TEXCOORD2.xx + u_xlat5.xy;
					    u_xlat5.xy = unity_WorldToLight[2].xy * vs_TEXCOORD2.zz + u_xlat5.xy;
