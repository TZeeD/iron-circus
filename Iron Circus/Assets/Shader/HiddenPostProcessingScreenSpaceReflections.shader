			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
					    ...
					    u_xlat3 = textureLod(_Resolve, vs_TEXCOORD1.xy, u_xlat3.x);
					    u_xlat4 = dot((-u_xlat6.xyz), u_xlat0.xyz);
					    u_xlat9 = u_xlat4 + u_xlat4;
					    u_xlat0.xyz = u_xlat0.xyz * (-vec3(u_xlat9)) + (-u_xlat6.xyz);
					    ...
					    u_xlat10 = u_xlat10 + 1.0;
					    u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
					    u_xlat6.xyz = (-u_xlat2.xyz) + vec3(u_xlat10);
					    u_xlat5.xyz = u_xlat5.xxx * u_xlat6.xyz + u_xlat2.xyz;
					    u_xlat6.xyz = texture(_CameraReflectionsTexture, vs_TEXCOORD1.xy).xyz;
					    u_xlat2 = texture(_MainTex, vs_TEXCOORD1.xy);
					    u_xlat2.xyz = (-u_xlat6.xyz) + u_xlat2.xyz;
					    u_xlat2.xyz = max(u_xlat2.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat18 = u_xlat3.w * u_xlat3.w;
					    u_xlat4 = u_xlat18 * 3.0;
					    u_xlat18 = u_xlat18 * 3.0 + -0.5;
					    ...
					    u_xlat18 = u_xlat18 * _Params.y;
					    u_xlat18 = clamp(u_xlat18, 0.0, 1.0);
					    u_xlat18 = (-u_xlat18) + 1.0;
					    u_xlat0.x = u_xlat0.x * u_xlat18;
					    u_xlat5.xyz = u_xlat3.xyz * u_xlat5.xyz + (-u_xlat6.xyz);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat5.xyz + u_xlat6.xyz;
					    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat1) + u_xlat2.xyz;
