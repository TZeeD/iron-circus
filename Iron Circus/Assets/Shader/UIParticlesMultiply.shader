			...
			Program "vp" {
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat4 = u_xlat1.y * unity_MatrixV[1].z;
					    u_xlat4 = unity_MatrixV[0].z * u_xlat1.x + u_xlat4;
					    u_xlat4 = unity_MatrixV[2].z * u_xlat1.z + u_xlat4;
					    u_xlat4 = unity_MatrixV[3].z * u_xlat1.w + u_xlat4;
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0 = vs_COLOR0 * u_xlat0 + vec4(-1.0, -1.0, -1.0, -1.0);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = u_xlat0 * u_xlat1 + vec4(-1.0, -1.0, -1.0, -1.0);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat2 = u_xlat1.w * vs_COLOR0.w;
					    u_xlat1 = vs_COLOR0 * u_xlat1 + vec4(-1.0, -1.0, -1.0, -1.0);
					    u_xlat1.xyz = vec3(u_xlat2) * u_xlat1.xyz;
					    SV_Target0.w = u_xlat2 * u_xlat1.w + 1.0;
					    SV_Target0.xyz = vec3(u_xlat0) * u_xlat1.xyz + vec3(1.0, 1.0, 1.0);
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    SV_Target0.w = u_xlat0.x * u_xlat2.w + 1.0;
					    u_xlat0.x = vs_TEXCOORD1;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    SV_Target0.xyz = u_xlat0.xxx * u_xlat3.xyz + vec3(1.0, 1.0, 1.0);
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
