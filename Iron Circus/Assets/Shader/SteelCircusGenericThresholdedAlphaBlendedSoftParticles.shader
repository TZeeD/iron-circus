Shader "SteelCircus/Generic/ThresholdedAlphaBlendedSoftParticles" {
	Properties {
		_TintColor ("Tint Color", Vector) = (0.5,0.5,0.5,0.5)
		_MainTex ("Particle Texture", 2D) = "white" {}
		_ThresholdTex ("Threshold Texture (send particle age % to texcoord0 .z (custom vertex streams)", 2D) = "white" {}
		_ThresholdScale ("Threshold sharpness", Float) = 100
		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					uniform  sampler2D _ThresholdTex;
					in  vec4 vs_COLOR0;
					...
					void main()
					{
					    u_xlat0 = texture(_ThresholdTex, vs_TEXCOORD0.xy);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat0.x = u_xlat0.x + (-vs_TEXCOORD0.z);
					    u_xlat0.x = u_xlat0.x * _ThresholdScale;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_ThresholdTex, vs_TEXCOORD0.xy);
					    u_xlat1.x = (-u_xlat1.x) + 1.0;
					    u_xlat1.x = u_xlat1.x + (-vs_TEXCOORD0.z);
					    u_xlat1.x = u_xlat1.x * _ThresholdScale;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat2.xyz + (-unity_FogColor.xyz);
