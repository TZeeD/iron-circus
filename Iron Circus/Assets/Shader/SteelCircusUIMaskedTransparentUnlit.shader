Shader "SteelCircus/UIMaskedTransparentUnlit" {
	Properties {
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					;
					    ...
					    u_xlat1 = texture(_TextureSample0, u_xlat6.xy);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_TextureSample0, u_xlat3.xy);
					    u_xlat2.xyz = vs_COLOR0.xyz;
					    u_xlat2.w = 1.0;
					    u_xlat1 = u_xlat1 * u_xlat2;
					...
					;
					    ...
					    u_xlat6 = u_xlat0.x * u_xlat3.x + -0.00100000005;
