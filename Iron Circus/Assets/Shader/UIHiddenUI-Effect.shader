	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "GRAYSCALE" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "ADD" "GRAYSCALE" }
					"vs_4_0
			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0 = texture(_ParamTex, u_xlat0.xy);
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat1 = u_xlat1 + _TextureSampleAdd;
					    u_xlat0.xzw = u_xlat1.xyz * vs_COLOR0.xyz + (-u_xlat1.xyz);
					    SV_Target0.xyz = u_xlat0.yyy * u_xlat0.xzw + u_xlat1.xyz;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					;
					    ...
					    u_xlat0.y = vs_TEXCOORD2;
					    u_xlat0 = texture(_ParamTex, u_xlat0.xy);
					    SV_Target0.xyz = vs_COLOR0.xyz * u_xlat0.yyy + u_xlat1.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat0.xzw * vs_COLOR0.xyz + (-u_xlat0.xzw);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = (-u_xlat1.xyz) + vec3(u_xlat6);
					    u_xlat0.xzw = u_xlat0.xxx * u_xlat2.xyz + u_xlat1.xyz;
					    SV_Target0.xyz = vs_COLOR0.xyz * u_xlat0.yyy + u_xlat0.xzw;
					    u_xlatb0.xy = greaterThanEqual(vs_TEXCOORD1.xyxx, _ClipRect.xyxx).xy;
					    u_xlatb0.zw = greaterThanEqual(_ClipRect.zzzw, vs_TEXCOORD1.xxxy).zw;
					    u_xlat0.x = u_xlatb0.x ? float(1.0) : 0.0;
					    u_xlat0.y = u_xlatb0.y ? float(1.0) : 0.0;
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					;
					    ...
					    if(((int(u_xlatb0.x) * int(0xffffffffu)))!=0){discard;}
					    u_xlat0.x = dot(u_xlat1.xyz, vec3(0.0396819152, 0.45802179, 0.00609653955));
					    u_xlat0.xyz = (-u_xlat1.xyz) + u_xlat0.xxx;
					    u_xlat2.x = 0.5;
					    u_xlat2.y = vs_TEXCOORD2;
					    u_xlat2 = texture(_ParamTex, u_xlat2.xy);
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					;
					    ...
					    u_xlat2 = texture(_ParamTex, u_xlat2.xy);
					    u_xlat0.xyz = u_xlat2.xxx * u_xlat0.xyz + u_xlat1.xyz;
					    SV_Target0.xyz = vs_COLOR0.xyz * u_xlat2.yyy + u_xlat0.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 hw_tier01 " {
