	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "GLOW_ON" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "GLOW_ON" "BEVEL_ON" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "GLOW_ON" "UNITY_UI_CLIP_RECT" "BEVEL_ON" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "UNDERLAY_ON" "UNITY_UI_CLIP_RECT" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "GLOW_ON" "UNITY_UI_CLIP_RECT" }
					"vs_4_0
				...
				SubProgram "d3d11 hw_tier00 " {
					Keywords { "UNITY_UI_ALPHACLIP" "GLOW_ON" "UNITY_UI_CLIP_RECT" "BEVEL_ON" }
					"vs_4_0
			...
			Program "fp" {
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
					    u_xlat8 = u_xlat5 * vs_TEXCOORD1.y + (-u_xlat8);
					    ...
					    u_xlat3.xzw = vs_COLOR0.xyz * _FaceColor.xyz;
					    ...
					    u_xlat1 = vec4(u_xlat17) * u_xlat1 + u_xlat4;
					    ...
					    u_xlat15 = max(u_xlat0.x, 0.0);
					    u_xlat0.x = (-u_xlat0.x) * _Diffuse + 1.0;
					    u_xlat15 = log2(u_xlat15);
					    u_xlat15 = u_xlat15 * _Reflectivity;
					    u_xlat15 = exp2(u_xlat15);
					    u_xlat3.xyz = vec3(u_xlat15) * _SpecularColor.xyz;
					    ...
					    u_xlat0.x = u_xlat10.x * u_xlat0.x + _Ambient;
					    u_xlat0.xzw = u_xlat3.xyz * u_xlat0.xxx + u_xlat2.xyz;
					    u_xlat2.x = _GlowOffset * _ScaleRatioB;
					    u_xlat2.x = u_xlat2.x * vs_TEXCOORD1.y;
					    u_xlat5 = (-u_xlat2.x) * 0.5 + u_xlat5;
					    u_xlatb2 = u_xlat5>=0.0;
					    u_xlat2.x = u_xlatb2 ? 1.0 : float(0.0);
					    u_xlat7 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat2.x = u_xlat2.x * u_xlat7 + _GlowInner;
					    u_xlat2.x = u_xlat2.x * vs_TEXCOORD1.y;
					    u_xlat7 = u_xlat2.x * 0.5 + 1.0;
					    ...
					    u_xlat5 = u_xlat5 * _GlowPower;
					    u_xlat5 = exp2(u_xlat5);
					    u_xlat5 = (-u_xlat5) + 1.0;
					    u_xlat5 = u_xlat2.x * u_xlat5;
					    u_xlat5 = dot(_GlowColor.ww, vec2(u_xlat5));
					    u_xlat5 = clamp(u_xlat5, 0.0, 1.0);
					    u_xlat1.xyz = _GlowColor.xyz * vec3(u_xlat5) + u_xlat0.xzw;
					    SV_Target0 = u_xlat1 * vs_COLOR0.wwww;
					    return;
					}"
				}
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat14 = u_xlat12 * vs_TEXCOORD1.y;
					    u_xlat12 = u_xlat12 * vs_TEXCOORD1.y + 1.0;
					    u_xlat0.x = u_xlat14 * 0.5 + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x / u_xlat12;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat12 = u_xlat1.w * u_xlat0.x + -0.00100000005;
					    u_xlat1 = u_xlat0.xxxx * u_xlat1;
					    ...
					    u_xlat3.xz = u_xlat0.xx * u_xlat3.xz;
					    u_xlat3.yz = u_xlat3.wy * u_xlat0.xx + (-u_xlat3.zx);
					    u_xlat3.x = float(-1.0);
					    u_xlat3.w = float(1.0);
					    ...
					    u_xlat0.x = u_xlat18 * u_xlat0.x + _BumpFace;
					    u_xlat2.xyz = (-u_xlat2.xyz) * u_xlat0.xxx + u_xlat3.xyz;
					    u_xlat0.x = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat2.xyz = u_xlat0.xxx * u_xlat2.xyz;
					    u_xlat0.x = dot(vs_TEXCOORD3.xyz, (-u_xlat2.xyz));
					    u_xlat0.x = u_xlat0.x + u_xlat0.x;
					    u_xlat3.xyz = u_xlat2.xyz * u_xlat0.xxx + vs_TEXCOORD3.xyz;
					    u_xlat3 = texture(_Cube, u_xlat3.xyz);
					    u_xlat4.xyz = (-_ReflectFaceColor.xyz) + _ReflectOutlineColor.xyz;
					    u_xlat0.xzw = vec3(u_xlat18) * u_xlat4.xyz + _ReflectFaceColor.xyz;
					    u_xlat0.xzw = u_xlat0.xzw * u_xlat3.xyz;
					    ...
					    u_xlat0.xzw = u_xlat2.xzw * vec3(u_xlat8) + u_xlat0.xzw;
					    u_xlat2.x = _GlowOffset * _ScaleRatioB;
					    u_xlat2.x = u_xlat2.x * vs_TEXCOORD1.y;
					    u_xlat6 = (-u_xlat2.x) * 0.5 + u_xlat6;
					    u_xlatb2 = u_xlat6>=0.0;
					    u_xlat2.x = u_xlatb2 ? 1.0 : float(0.0);
					    u_xlat8 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat2.x = u_xlat2.x * u_xlat8 + _GlowInner;
					    u_xlat2.x = u_xlat2.x * vs_TEXCOORD1.y;
					    u_xlat8 = u_xlat2.x * 0.5 + 1.0;
					    u_xlat2.x = u_xlat2.x * 0.5;
					    u_xlat2.x = min(u_xlat2.x, 1.0);
					    u_xlat2.x = sqrt(u_xlat2.x);
					    ...
					    u_xlat6 = u_xlat6 * _GlowPower;
					    u_xlat6 = exp2(u_xlat6);
					    u_xlat6 = (-u_xlat6) + 1.0;
					    u_xlat6 = u_xlat2.x * u_xlat6;
					    u_xlat6 = dot(_GlowColor.ww, vec2(u_xlat6));
					    u_xlat6 = clamp(u_xlat6, 0.0, 1.0);
					    u_xlat1.xyz = _GlowColor.xyz * vec3(u_xlat6) + u_xlat0.xzw;
					    SV_Target0 = u_xlat1 * vs_COLOR0.wwww;
					    return;
					}"
				}
				...
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat12 = vs_TEXCOORD1.w + _BevelOffset;
					    u_xlat3.xy = vec2(0.5, 0.5) / vec2(_TextureWidth, _TextureHeight);
					    u_xlat3.z = 0.0;
					    u_xlat4 = (-u_xlat3.xzzy) + vs_TEXCOORD0.xyxy;
					    u_xlat3 = u_xlat3.xzzy + vs_TEXCOORD0.xyxy;
					    ...
					    u_xlat5.w = u_xlat3.w;
					    u_xlat5.y = u_xlat4.w;
					    u_xlat3 = vec4(u_xlat12) + u_xlat5;
					    u_xlat3 = u_xlat3 + vec4(-0.5, -0.5, -0.5, -0.5);
					    u_xlat12 = _BevelWidth + _OutlineWidth;
					    u_xlat12 = max(u_xlat12, 0.00999999978);
					    u_xlat3 = u_xlat3 / vec4(u_xlat12);
					    u_xlat12 = u_xlat12 * _Bevel;
					    ...
					    u_xlat4 = u_xlat3 * vec4(2.0, 2.0, 2.0, 2.0) + vec4(-1.0, -1.0, -1.0, -1.0);
					    u_xlat4 = -abs(u_xlat4) + vec4(1.0, 1.0, 1.0, 1.0);
					    u_xlat20 = _ShaderFlags * 0.5;
					    u_xlatb5 = u_xlat20>=(-u_xlat20);
					    u_xlat20 = fract(abs(u_xlat20));
					    u_xlat20 = (u_xlatb5) ? u_xlat20 : (-u_xlat20);
					    u_xlatb20 = u_xlat20>=0.5;
					    u_xlat3 = (bool(u_xlatb20)) ? u_xlat4 : u_xlat3;
					    u_xlat4 = u_xlat3 * vec4(1.57079601, 1.57079601, 1.57079601, 1.57079601);
					    u_xlat4 = sin(u_xlat4);
					    u_xlat4 = (-u_xlat3) + u_xlat4;
					    u_xlat3 = vec4(vec4(_BevelRoundness, _BevelRoundness, _BevelRoundness, _BevelRoundness)) * u_xlat4 + u_xlat3;
					    u_xlat20 = (-_BevelClamp) + 1.0;
					    u_xlat3 = min(vec4(u_xlat20), u_xlat3);
					    u_xlat3.xz = vec2(u_xlat12) * u_xlat3.xz;
					    u_xlat3.yz = u_xlat3.wy * vec2(u_xlat12) + (-u_xlat3.zx);
					    u_xlat3.x = float(-1.0);
					    u_xlat3.w = float(1.0);
					    u_xlat12 = dot(u_xlat3.xy, u_xlat3.xy);
					    u_xlat12 = inversesqrt(u_xlat12);
					    u_xlat20 = dot(u_xlat3.zw, u_xlat3.zw);
					    u_xlat20 = inversesqrt(u_xlat20);
					    u_xlat4.x = u_xlat20 * u_xlat3.z;
					    ...
					    u_xlat12 = u_xlat18 * u_xlat12 + _BumpFace;
					    u_xlat2.xyz = (-u_xlat2.xyz) * vec3(u_xlat12) + u_xlat3.xyz;
					    u_xlat12 = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat12 = inversesqrt(u_xlat12);
					    u_xlat2.xyz = vec3(u_xlat12) * u_xlat2.xyz;
					    u_xlat12 = dot(vs_TEXCOORD3.xyz, (-u_xlat2.xyz));
					    u_xlat12 = u_xlat12 + u_xlat12;
					    u_xlat3.xyz = u_xlat2.xyz * vec3(u_xlat12) + vs_TEXCOORD3.xyz;
					    u_xlat3 = texture(_Cube, u_xlat3.xyz);
					    u_xlat4.xyz = (-_ReflectFaceColor.xyz) + _ReflectOutlineColor.xyz;
					    u_xlat4.xyz = vec3(u_xlat18) * u_xlat4.xyz + _ReflectFaceColor.xyz;
					    ...
					    u_xlat12 = (-u_xlat12) * _Diffuse + 1.0;
					    u_xlat2.x = log2(u_xlat2.x);
					    u_xlat2.x = u_xlat2.x * _Reflectivity;
					    ...
					    u_xlat2.xyz = u_xlat2.xyz * u_xlat1.www + u_xlat1.xyz;
					    u_xlat2.xyz = vec3(u_xlat12) * u_xlat2.xyz;
					    u_xlat12 = (-_Ambient) + 1.0;
					    u_xlat12 = u_xlat18 * u_xlat12 + _Ambient;
					    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat12) + u_xlat3.xyz;
					    u_xlat6.y = _GlowOffset * _ScaleRatioB;
					    u_xlat6.xy = u_xlat6.xy * vs_TEXCOORD1.yy;
					    ...
					    u_xlat12 = u_xlat12 * vs_TEXCOORD1.y;
					    ...
					    u_xlat6.x = u_xlat6.x * _GlowPower;
					    u_xlat6.x = exp2(u_xlat6.x);
					    u_xlat6.x = (-u_xlat6.x) + 1.0;
					    u_xlat6.x = u_xlat12 * u_xlat6.x;
					    u_xlat6.x = dot(_GlowColor.ww, u_xlat6.xx);
					    u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
					    u_xlat1.xyz = _GlowColor.xyz * u_xlat6.xxx + u_xlat2.xyz;
					    u_xlat0 = u_xlat0.xxxx * u_xlat1;
					    SV_Target0 = u_xlat0 * vs_COLOR0.wwww;
					    return;
					}"
