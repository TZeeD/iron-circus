			...
			Program "fp" {
				SubProgram "d3d11 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = u_xlat0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
					    u_xlat0.xyz = max(u_xlat0.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat1 = texture(_History1LumaTex, vs_TEXCOORD1.xy);
					    ...
					    u_xlat3 = texture(_History1ChromaTex, u_xlat2.zw);
					    u_xlat15 = u_xlat3.x + -0.5;
					    u_xlat3.xy = vec2(u_xlat15) * vec2(1.40199995, 0.714139998);
					    u_xlat4 = texture(_History1ChromaTex, u_xlat2.xy);
					    u_xlat15 = u_xlat4.x + -0.5;
					    u_xlat3.z = u_xlat15 * -0.344139993 + (-u_xlat3.y);
					    u_xlat3.w = u_xlat15 * 1.77199996;
					    u_xlat1.xyz = u_xlat1.xxx + u_xlat3.xzw;
					    u_xlat0.xyz = u_xlat1.xyz * vec3(vec3(_History1Weight, _History1Weight, _History1Weight)) + u_xlat0.xyz;
					    u_xlat1 = texture(_History2LumaTex, vs_TEXCOORD1.xy);
					    u_xlat3 = texture(_History2ChromaTex, u_xlat2.zw);
					    u_xlat15 = u_xlat3.x + -0.5;
					    u_xlat3.xy = vec2(u_xlat15) * vec2(1.40199995, 0.714139998);
					    u_xlat4 = texture(_History2ChromaTex, u_xlat2.xy);
					    u_xlat15 = u_xlat4.x + -0.5;
					    u_xlat3.z = u_xlat15 * -0.344139993 + (-u_xlat3.y);
					    u_xlat3.w = u_xlat15 * 1.77199996;
					    u_xlat1.xyz = u_xlat1.xxx + u_xlat3.xzw;
					    u_xlat0.xyz = u_xlat1.xyz * vec3(_History2Weight) + u_xlat0.xyz;
					    u_xlat1 = texture(_History3ChromaTex, u_xlat2.zw);
					    u_xlat3 = texture(_History4ChromaTex, u_xlat2.zw);
					    u_xlat15 = u_xlat3.x + -0.5;
					    u_xlat3.xy = vec2(u_xlat15) * vec2(1.40199995, 0.714139998);
					    u_xlat15 = u_xlat1.x + -0.5;
					    u_xlat1.xy = vec2(u_xlat15) * vec2(1.40199995, 0.714139998);
					    u_xlat4 = texture(_History3ChromaTex, u_xlat2.xy);
					    u_xlat2 = texture(_History4ChromaTex, u_xlat2.xy);
					    u_xlat15 = u_xlat2.x + -0.5;
					    u_xlat2.x = u_xlat4.x + -0.5;
					    u_xlat1.z = u_xlat2.x * -0.344139993 + (-u_xlat1.y);
					    u_xlat1.w = u_xlat2.x * 1.77199996;
					    u_xlat2 = texture(_History3LumaTex, vs_TEXCOORD1.xy);
